...
> This module now lives in [`opstimus/terraform-modules`](https://github.com/opstimus/terraform-modules) at `modules/aws-ecs-autoscaling-standard`.
>
> ```hcl
> source = "git::https://github.com/opstimus/terraform-modules.git//modules/aws-ecs-autoscaling-standard?ref=aws-ecs-autoscaling-standard/v2.0.0"
> ```
>
